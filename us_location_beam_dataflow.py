...
def run():         
    ...
    sql = 'SELECT id, province_state, country_region, latitude, longitude, fips, admin2, combined_key FROM covid19_jhu_csse_modeled.us_location'
